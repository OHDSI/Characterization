...
#> Creating directory /tmp/RtmpCxthYQ/runChar
#> Creating directory /tmp/RtmpCxthYQ/runChar/execution
...
#> Inserting data took 0.0297 secs
...
#> Loading andromeda result at /tmp/RtmpCxthYQ/runChar/execution/tte_1
```
