...
#> Creating directory /tmp/Rtmp0tc6dI/runChar
#> Creating directory /tmp/Rtmp0tc6dI/runChar/execution
...
#> Inserting data took 0.0355 secs
#> Computing time to event results
#> Executing SQL took 0.0227 secs
#> Computing time-to-event for 2 T-O pairs took 0.277 secs
...
#> Loading andromeda result at /tmp/Rtmp0tc6dI/runChar/execution/tte_1
```
