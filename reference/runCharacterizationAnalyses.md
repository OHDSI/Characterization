...
#> Creating directory /tmp/RtmpqzoXPL/runChar
#> Creating directory /tmp/RtmpqzoXPL/runChar/execution
...
#> Inserting data took 0.0345 secs
#> Computing time to event results
#> Executing SQL took 0.0222 secs
...
#> Loading andromeda result at /tmp/RtmpqzoXPL/runChar/execution/tte_1
```
