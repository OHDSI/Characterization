...
#> Creating directory /tmp/RtmpBpCScL/runChar
#> Creating directory /tmp/RtmpBpCScL/runChar/execution
...
#> Computing time-to-event for 2 T-O pairs took 0.233 secs
...
#> Loading andromeda result at /tmp/RtmpBpCScL/runChar/execution/tte_1
```
