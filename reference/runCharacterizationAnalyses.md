...
#> Creating directory /tmp/RtmpFufdY8/runChar
#> Creating directory /tmp/RtmpFufdY8/runChar/execution
...
#> Inserting data took 0.0307 secs
#> Computing time to event results
#> Executing SQL took 0.0201 secs
#> Computing time-to-event for 2 T-O pairs took 0.244 secs
...
#> Loading andromeda result at /tmp/RtmpFufdY8/runChar/execution/tte_1
```
