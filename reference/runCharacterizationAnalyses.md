...
#> Creating directory /tmp/RtmpRCdIQR/runChar
#> Creating directory /tmp/RtmpRCdIQR/runChar/execution
...
#> Executing SQL took 0.00744 secs
...
#> Inserting data took 0.0439 secs
...
#> ℹ Run duckdb(shared_home = FALSE) to accept the temporary directory (and silence this message).
#> ℹ See ?duckdb_storage for details and alternatives.
#> Computing time-to-event for 2 T-O pairs took 0.312 secs
#> exporting to andromeda
#> Disconnected Andromeda. This data object can no longer be used
#> Removing any existing results in outputFolder directory
#> Loading andromeda result at /tmp/RtmpRCdIQR/runChar/execution/target_attrition
#> duckdb keeps downloaded extensions and secrets in a temporary directory:
#> ℹ /tmp/RtmpRCdIQR/duckdb
#> This is removed when the R session ends.
#> • Extensions are re-downloaded each session.
...
#> ℹ Run duckdb(shared_home = FALSE) to accept the temporary directory (and silence this message).
#> ℹ See ?duckdb_storage for details and alternatives.
#> Loading andromeda result at /tmp/RtmpRCdIQR/runChar/execution/target_counts
#> duckdb keeps downloaded extensions and secrets in a temporary directory:
#> ℹ /tmp/RtmpRCdIQR/duckdb
#> This is removed when the R session ends.
#> • Extensions are re-downloaded each session.
...
#> ℹ Run duckdb(shared_home = FALSE) to accept the temporary directory (and silence this message).
#> ℹ See ?duckdb_storage for details and alternatives.
#> Loading andromeda result at /tmp/RtmpRCdIQR/runChar/execution/tte_1
#> duckdb keeps downloaded extensions and secrets in a temporary directory:
#> ℹ /tmp/RtmpRCdIQR/duckdb
#> This is removed when the R session ends.
#> • Extensions are re-downloaded each session.
