...
#> Creating directory /tmp/RtmpzkXcNO/runChar
#> Creating directory /tmp/RtmpzkXcNO/runChar/execution
...
#> Inserting data took 0.0327 secs
#> Computing time to event results
#> Executing SQL took 0.0216 secs
#> Computing time-to-event for 2 T-O pairs took 0.247 secs
...
#> Loading andromeda result at /tmp/RtmpzkXcNO/runChar/execution/tte_1
```
