...
#> Creating directory /tmp/Rtmp7RaDrS/runChar
#> Creating directory /tmp/Rtmp7RaDrS/runChar/execution
...
#> Computing time-to-event for 2 T-O pairs took 0.238 secs
...
#> Loading andromeda result at /tmp/Rtmp7RaDrS/runChar/execution/tte_1
```
