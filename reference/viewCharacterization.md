...
#> Creating directory /tmp/RtmpD1c72G/view
#> Creating directory /tmp/RtmpD1c72G/view/execution
#> Connecting using SQLite driver
#> Extracting cohort jobs
#> Adding 1 Target Cohort Jobs containing 2 targets
#> Inserting data took 0.009 secs
...
#> Inserting data took 0.00578 secs
#> Computing time to event results
#> Executing SQL took 0.0117 secs
#> duckdb keeps downloaded extensions and secrets in a temporary directory:
#> ℹ /tmp/RtmpD1c72G/duckdb
#> This is removed when the R session ends.
#> • Extensions are re-downloaded each session.
...
#> ℹ Run duckdb(shared_home = FALSE) to accept the temporary directory (and silence this message).
#> ℹ See ?duckdb_storage for details and alternatives.
#> Computing time-to-event for 2 T-O pairs took 0.348 secs
#> exporting to andromeda
#> Disconnected Andromeda. This data object can no longer be used
#> Removing any existing results in outputFolder directory
#> Loading andromeda result at /tmp/RtmpD1c72G/view/execution/target_attrition
#> duckdb keeps downloaded extensions and secrets in a temporary directory:
#> ℹ /tmp/RtmpD1c72G/duckdb
#> This is removed when the R session ends.
#> • Extensions are re-downloaded each session.
...
#> ℹ Run duckdb(shared_home = FALSE) to accept the temporary directory (and silence this message).
#> ℹ See ?duckdb_storage for details and alternatives.
#> Loading andromeda result at /tmp/RtmpD1c72G/view/execution/target_counts
#> duckdb keeps downloaded extensions and secrets in a temporary directory:
#> ℹ /tmp/RtmpD1c72G/duckdb
#> This is removed when the R session ends.
#> • Extensions are re-downloaded each session.
...
#> ℹ Run duckdb(shared_home = FALSE) to accept the temporary directory (and silence this message).
#> ℹ See ?duckdb_storage for details and alternatives.
#> Loading andromeda result at /tmp/RtmpD1c72G/view/execution/tte_1
#> duckdb keeps downloaded extensions and secrets in a temporary directory:
#> ℹ /tmp/RtmpD1c72G/duckdb
#> This is removed when the R session ends.
#> • Extensions are re-downloaded each session.
