...
#> Creating directory /tmp/Rtmpm5gzJo/runChar
#> Creating directory /tmp/Rtmpm5gzJo/runChar/execution
...
#> Inserting data took 0.034 secs
#> Computing time to event results
#> Executing SQL took 0.0221 secs
#> Computing time-to-event for 2 T-O pairs took 0.259 secs
...
#> Loading andromeda result at /tmp/Rtmpm5gzJo/runChar/execution/tte_1
```
