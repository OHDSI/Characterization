...
#> Creating directory /tmp/Rtmp2RLAmD/runChar
#> Creating directory /tmp/Rtmp2RLAmD/runChar/execution
...
#> Inserting data took 0.03 secs
#> Computing time to event results
#> Executing SQL took 0.0211 secs
#> Computing time-to-event for 2 T-O pairs took 0.245 secs
...
#> Loading andromeda result at /tmp/Rtmp2RLAmD/runChar/execution/tte_1
```
