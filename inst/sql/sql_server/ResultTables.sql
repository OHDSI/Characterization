...
CREATE TABLE @my_schema.@table_prefixrisk_factor_covariates (
    ...
    covariate_id bigint NOT NULL,
    non_case_sum_value bigint,
    non_case_average_value float,
    case_sum_value bigint,
...
CREATE TABLE @my_schema.@table_prefixcase_series_covariates (
    ...
    characterization_case_id bigint NOT NULL,
    covariate_id bigint NOT NULL,
    before_sum_value bigint,
    before_average_value float,
    during_sum_value bigint,
    during_average_value float,
    after_sum_value bigint,
