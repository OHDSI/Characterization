...
from
  ...
  (
	...
	on dc1.subject_id = io1.subject_id and dc1.observation_id = io1.observation_id
	...
	on dc1.subject_id = ro1.subject_id and dc1.observation_id = ro1.observation_id
	...
	on dc1.subject_id = ro0.subject_id and dc1.observation_id = ro0.observation_id
	...
	on dc1.subject_id = de1.subject_id and dc1.observation_id = de1.observation_id
	...
	and de1.cohort_start_date > dateadd(day, @dechallenge_evaluation_window, dc1.cohort_end_date)   --using same dechallenge window to detrmine when rechallenge attempt can start
	inner join #outcome_cohort ro1
	on de1.subject_id = ro1.subject_id and de1.observation_id = ro1.observation_id
	and io1.cohort_definition_id = ro1.cohort_definition_id
